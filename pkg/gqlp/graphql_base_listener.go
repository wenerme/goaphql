...
// EnterGraphql is called when production graphql is entered.
func (s *BaseGraphQLListener) EnterGraphql(ctx *GraphqlContext) {}

// ExitGraphql is called when production graphql is exited.
func (s *BaseGraphQLListener) ExitGraphql(ctx *GraphqlContext) {}
...
func (s *BaseGraphQLListener) EnterTypeSpec(ctx *TypeSpecContext) {}

// ExitTypeSpec is called when production typeSpec is exited.
func (s *BaseGraphQLListener) ExitTypeSpec(ctx *TypeSpecContext) {}
